...
export class Migration20260619120000 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "training_session" add column "arrows_per_set" int null;`);
    this.addSql(`alter table "training_session" add column "score_total" int null;`);
    this.addSql(`alter table "training_session" add column "notes" varchar(255) null;`);
    this.addSql(`alter table "training_session" add column "mood" varchar(255) null;`);
  }
