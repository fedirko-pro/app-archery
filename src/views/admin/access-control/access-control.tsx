            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  {ROLE_ORDER.map((role) => (
                    <TableCell key={role} align="center" sx={{ fontWeight: 600, minWidth: 100 }}>
                    ...
                    {ROLE_ORDER.map((role) => {
                      ...
                      if (canEdit) {
                        cellContent = (
                          <Checkbox
                            ...
                            checked={checked}
                            disabled={!!updating}
                            onChange={() => handleToggle(role, row.permissionKey, !checked)}
                            sx={{ p: 0 }}
                          />
                        );
                      } else if (checked) {
                      ...
                      return (
                        <TableCell key={role} align="center">
                          {cellContent}
                          {isUpdating && (
                            <CircularProgress size={16} sx={{ ml: 0.5, verticalAlign: 'middle' }} />
                          )}
                        </TableCell>
                      );
                    })}
